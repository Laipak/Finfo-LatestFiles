...
<html lang="en">
    <head>
        ...
        <style type="text/css">
            ...
            body {
                background: {{ isset($setting->background_color)? $setting->background_color :"#fff" }} !important; 
        ...
        <div class="container" style="min-height: 100vh; position: relative; padding-left: 21px;">
            <div class="top" style="min-height: 100px;">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="logo">
                        @if($company_logo != '')
                            <img src="/public/{{$company_logo}}" style="max-width: 326px; max-height: 100%; overflow: hidden;" alt="company_logo">
                        @else 
                            <h1>Company Logo</h1>
                        @endif                            
                        </div>
            ...
            <footer class="main-footer">
                ...
                <div class="pull-right hidden-xs">
                    <span><a href="" title="Sitemap" style="color:#000;"><b id="sitemap">Sitemap</b></a></span>
                </div>
