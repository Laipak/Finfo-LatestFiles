	...
	<section class="content financial-result" id="list-page">
            ...
            <div class="row head-search">
                <div class="col-sm-6 title-mobile">
                        <lable class="label-title">All Financials</lable>
                </div>
                <div class="col-sm-6"> 
	            		...
	            		<table id="table-latest-financial" class="table table-bordered table-striped">
	                        ...
	                        @if($financialHighlights)
	                            ...
	                            <tr>
	                                ...
	                                <td>{{$data->year}}</td>
                                  <!--  <td>{{($data->status == 0) ? "Publish" : "Unpublish"}}</td>-->
                                  ...
                                  <td>
                                    ...
                                    <td>{{ isset($data->publish_date) && !empty($data->publish_date)  ? date('d F, Y', strtotime($data->publish_date)) : "-"}}</td>
	                                <td class="text-center"><a href="{{route('package.admin.latest-financial-highlights.form.id', $data->id)}}">Edit</a> | 
...
<script type="text/javascript">
    ...
    $('.last_fin_hig_list').addClass('active');
