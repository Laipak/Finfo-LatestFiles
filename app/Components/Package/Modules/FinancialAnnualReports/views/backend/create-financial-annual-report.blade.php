...
@section('content')
    <section class="content" id="financial-annual-report">
        ...
        <div class="row">
            {!! Form::open(array('route' => 'package.admin.financial-annual-reports.save', 'method' => 'post','id' => 'myform', 'files'=> true)) !!}
            <div class="col-md-6">
                    <div class="form-group">
                            {!! Form::label('title', 'Title') !!}
                            {!! Form::text('title', Input::old('title'), ['class' => 'form-control', 'required' => 'true', 'placeholder' => 'Title', 'minlength' => 5 , 'maxlength'=>50,]) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-xs-8 upload-file">
                                    {!! Form::text('file_upload', Input::old('file_upload'), ['class' => 'file-upload-input form-control','required' => 'true', 'placeholder' => 'Support only pdf', 'id' => 'file_upload', 'readonly' => '']) !!}
                                </div>
                    ...
                    <div class="form-group">
                            ...
                            {!! Form::textarea('description', Input::old('description'), ['class' => 'form-control', 'required' => 'true','placeholder' => 'Description', 'minlength' => 5 , 'maxlength'=>100,]) !!}
                            {!! $errors->first('description', '<span class="help-block">:message</span>') !!}
                    </div>
                   
                    <div class="form-group">
                            {!! Form::label('financial_year', 'Financial year') !!}
                            {!! Form::select('financial_year', $year, '', array('class' => 'form-control','required' => 'true',)) !!}
