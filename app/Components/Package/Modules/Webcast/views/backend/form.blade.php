...
@section('content')
    <section class="content" id="financial-annual-report">
        <div class="row head-search">
            <div class="col-sm-6">
                <lable class="label-title">Add New Webcast</lable>
            </div>
        </div>
        <div class="row">
            {!! Form::open(array('route' => 'package.admin.webcast.save', 'id' => 'frm-webcast')) !!}
            <div class="col-md-6">

                <div class="form-group">
                        {!! Form::label('quarter', 'Quarter') !!}
                        {!! Form::select('quarter', $quarter, Input::old('quarter'), array('class' => 'form-control')); !!}
                ...
                <div class="form-group">
                        ...
                        {!! Form::select('year', $year, Input::old('year'), array('class' => 'form-control')); !!}
                        {!! $errors->first('year', '<span class="help-block">:message</span>') !!}
                </div>

                <div class="form-group">
                        {!! Form::label('url', 'Url') !!}
                        {!! Form::text('url', Input::old('url'), ['class' => 'form-control', 'placeholder' => 'Url    Ex: http://www.abc.com']) !!}
                        {!! $errors->first('url', '<span class="help-block">:message</span>') !!}
                </div>

                <div class="form-group">
                        {!! Form::label('caption', 'Caption') !!}
                        {!! Form::text('caption', Input::old('caption'), ['class' => 'form-control', 'placeholder' => 'Caption']) !!}
