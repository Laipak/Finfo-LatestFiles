    ...
    <section class="content" id="newsletter">
       @if(Session::has('global'))
            <div class="alert alert-warning">
                ...
                Mailer not configured, <a href="https://<?php echo $_SERVER['HTTP_HOST']; ?>/admin/newsletter-broadcast/email-seed-list/form"> please configure here.</a>
            </div>
        @endif
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                           <label style="padding: 0;">
                             <input type="checkbox" class="js-switch schedule_it"  name="schedule_it" value="1" {{($reach_limit)? 'disabled': ''}} /> <b>Schedule</b>
                           </label>
                        </div>
                    </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 schedule-content">
                @if($reach_limit)
