<div class="modal sim-edit" id="sim-edit-image">
<div class="sim-edit-box" style="height:251px;" >
<div class="sim-edit-box-title">Edit Image</div>
<div class="sim-edit-box-content">
  	<div class="form-group">
		<lable class="col-sm-4 control-labe" style=" margin-top: 6px;" ><strong>Position:</strong></lable>
    	<div class="col-sm-8">
    ...
    <div class="form-group" >
		<lable class="col-sm-4 control-labe" style=" margin-top: 6px;" ><strong>Size:</strong></lable>
    	<div class="col-sm-8">
            <select class="form-control" id="img-size" name="size">
    ...
    {!! Form::open(array('id' => 'frm-image', 'files'=> true)) !!}
        <input type="file" id="image-file" name="image-file" class="hide">
        <input type='hidden' name='old-img' id="old-img"> 
...
<div class="modal sim-edit" id="sim-edit-link">
<div class="sim-edit-box" style="height:260px;">
...
<div class="modal sim-edit" id="sim-edit-title">
...
<div class="modal sim-edit" id="sim-edit-text">
<div class="sim-edit-box">
...
<div class="modal sim-edit" id="sim-edit-icon">
<div class="sim-edit-box" style="height:590px;">
