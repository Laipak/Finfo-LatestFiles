...
<div class="panel-grid" id="pg-453-5" >
    <div class="panel-row-style-default panel-row-style nav-one-page" style="background-color: #ffffff; padding-top: 100px; padding-bottom: 100px; " overlay="background-color: rgba(255,255,255,0); " id="pricing">
        <div class="container">
            <div class="panel-grid-cell" id="pgc-453-5-0" >
                ...
                <div class="panel-builder widget-builder widget_origin_title panel-first-child" id="panel-453-4-0-0">
                    <div class="origin-widget origin-widget-title origin-widget-title-simple-simple align-center text-dark">
                        <h3  class="align-center">Congratulation!</h3><div class="divider colored"></div>
                    </div>
                </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-8 col-lg-offset-3 text-center">
                                        <h4>You have verified successfully!, your account will activated in the next 1 day.</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@stop
@section('seo')
    <title>Finfo | Registration - successful</title>
