		...
		<div class="row">
			...
			<p class="title-company">648A Geylang Road, Singapore 389578
			 ...
			 <table class="table table-tax">
				<tr>
					<th>TAX INVOICE #{{$data['invoice']['invoice_number']}} <br/> Payment Date: {{\Carbon\Carbon::parse($data['invoice']['invoice_date'])->format('d/M/Y')}}</th>
				</tr>
				<tr>
					<td >
						<p>Invoiced To</p>
		...
		<div class="row">
			...
			<table class="table tra">
				...
				<tr>
					...
					<td class='td-second'>{{\Carbon\Carbon::parse($data['invoice']['invoice_date'])->format('d/M/Y')}}</td>
				</tr>
				...
				<tr>
					...
					<td class='td-second'>Credit Card ({{$data['payment_method']}})</td>
				</tr>
				<tr>
					<td class='td-first'>
					...
					<td class='td-second'>{{$data['invoice']['transaction_id']}}</td>
				</tr>
				<tr>
					<td class='td-first'>
